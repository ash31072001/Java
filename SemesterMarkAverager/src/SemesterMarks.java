...
public class SemesterMarks {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter the marks of 8 semesters respectively: ");
		...
		calculateAverage( sem1,  sem2,  sem3, sem4, sem5, sem6, sem7, sem8);

	}
	public static int calculateAverage(int sem1, int sem2, int sem3, int sem4, int sem5, int sem6, int sem7, int sem8) {
